...
public static class HeightMapGenerator2 {

    static float[,] falloffMap;

    public static HeightMap2 GenerateHeightMap(int size, HeightMapSettings settings, Vector2 sampleCentre) {
        ...
        return new HeightMap2(values, minValue, maxValue);
    }
...
public struct HeightMap2 {
    ...
    public HeightMap2(float[,] values, float minValue, float maxValue) {
        this.values = values;
